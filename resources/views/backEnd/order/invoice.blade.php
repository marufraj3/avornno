                        ...
                        <tr>
                            <td style="width: 40%; float: left; padding-top: 15px;">
                                ...
                                <div class="invoice_form">
                                    ...
                                    <p style="font-size:16px;line-height:1.8;color:#222">{{ optional($contact)->phone }}</p>
                                    <p style="font-size:16px;line-height:1.8;color:#222">{{ optional($contact)->email }}</p>
                            {{-- ⭐ SHOW ORDER NOTE --}}
...
<div class="pos-receipt">
    <div class="rh">
        ...
        @if(optional($contact)->address)<p>{{ $contact->address }}</p>@endif
        @if(optional($contact)->phone)<p>Phone: {{ $contact->phone }}</p>@endif
        @if(optional($contact)->email)<p>{{ $contact->email }}</p>@endif
    </div>
