                                ...
                                <div class="col-12">
                                    ...
                                    <div class="mt-2 d-flex flex-wrap gap-3 align-items-center">
                                        @if($order->phone)
                                            ...
                                            @php
                                                $wa = preg_replace('/[^0-9]/', '', (string) $order->phone);
                                                if (strlen($wa) === 11 && str_starts_with($wa, '0')) { $wa = '88'.$wa; }
                                                $waText = rawurlencode('আপনার অর্ডারটি অসম্পূর্ণ আছে। শেষ করতে চান?');
                                            @endphp
                                            <a href="https://wa.me/{{ $wa }}?text={{ $waText }}" target="_blank" rel="noopener" class="btn btn-sm btn-success">
                                                WhatsApp রিমাইন্ডার
                                            </a>
                                        @endif
