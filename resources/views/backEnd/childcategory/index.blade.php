...
<div class="container-fluid">
    ...
    <div class="page-title-box d-flex align-items-center justify-content-between py-3">
        <div>
            <h4 class="page-title mb-1 text-dark fw-bold">Childcategories</h4>
            <p class="text-muted font-size-13 mb-0">Manage the third level of your catalog hierarchy with clear mapping.</p>
        </div>
