    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between py-3">
                <div>
                    <h4 class="page-title mb-1 text-dark fw-bold">Add New Product</h4>
                    <p class="text-muted font-size-13 mb-0">Create a new catalog item with variants, SEO data, media and delivery settings.</p>
                </div>
