...
.category-card{background:var(--paper,#fff);border:1px solid var(--line,#e8e8e8);border-radius:14px;text-align:center;transition:transform .2s ease,border-color .2s ease,box-shadow .2s ease;cursor:pointer;text-decoration:none;display:block}
.category-card:hover{transform:translateY(-3px);border-color:var(--accent,#e53e3e);box-shadow:0 8px 25px rgba(0,0,0,.08)}
.category-card img{object-fit:cover;border-radius:12px;display:block;background:var(--soft,#f7f7f7)}
