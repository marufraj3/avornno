...
// ✅ নতুন Minimal Dashboard (mobile-first, Tailwind)
Route::get('/admin/minimal-dashboard', [App\Http\Controllers\Admin\DashboardController::class, 'minimalDashboard'])
    ->name('admin.minimal_dashboard');
...
Route::group(['prefix'=>'customer','namespace'=>'Frontend', 'middleware' => ['ipcheck','check_refer']], function() {
    ...
    Route::post('/order/{id}/upsell', [CustomerController::class, 'addUpsell'])->name('customer.order_upsell');
...
Route::get('dashboard', [DashboardController::class, 'dashboard'])->name('admin.dashboard');
    ...
    Route::post('campaign/{id}/products', [CampaignController::class,'syncProducts'])->name('campaign.products.sync');
    ...
    // Order route 
    Route::get('order-search', [OrderController::class, 'globalSearch'])->name('admin.order.search');
    ...
    Route::get('order/quick-view/{order}', [OrderController::class,'quickView'])->name('admin.order.quick_view');
    Route::get('order/quick-view-json/{invoice_id}', [OrderController::class,'quickViewJson'])->name('admin.order.quick_view_json');
